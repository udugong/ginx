...
func NewManagement[T any](accessJWTOptions Options,
	opts ...ManagementOption[T]) *Management[T] {
...
type ManagementOption[T any] interface {
	apply(*Management[T])
}

type funcManagementOption[T any] struct {
	f func(*Management[T])
}

func (fdo *funcManagementOption[T]) apply(do *Management[T]) {
	fdo.f(do)
}

func newManagementFuncOption[T any](f func(*Management[T])) *funcManagementOption[T] {
	return &funcManagementOption[T]{
		f: f,
	}
}

// WithAllowTokenHeader 设置允许 token 的请求头.
func WithAllowTokenHeader[T any](header string) ManagementOption[T] {
	return newManagementFuncOption[T](func(m *Management[T]) {
		m.allowTokenHeader = header
	})
}

// WithExposeAccessHeader 设置公开资源令牌的请求头.
func WithExposeAccessHeader[T any](header string) ManagementOption[T] {
	return newManagementFuncOption[T](func(m *Management[T]) {
...
func WithExposeRefreshHeader[T any](header string) ManagementOption[T] {
	return newManagementFuncOption[T](func(m *Management[T]) {
...
func WithRefreshJWTOptions[T any](refreshOpts Options) ManagementOption[T] {
	return newManagementFuncOption[T](func(m *Management[T]) {
...
func WithRotateRefreshToken[T any](isRotate bool) ManagementOption[T] {
	return newManagementFuncOption[T](func(m *Management[T]) {
...
// WithNowFunc 设置当前时间.
// 一般用于测试固定 jwt.
func WithNowFunc[T any](nowFunc func() time.Time) ManagementOption[T] {
	return newManagementFuncOption[T](func(m *Management[T]) {
		m.nowFunc = nowFunc
	})
}
